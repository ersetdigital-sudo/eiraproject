  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="disp text-xl font-extrabold uppercase tracking-tight text-[var(--ink)]">Edit Produk</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="rounded-xl border border-[var(--line)] bg-[var(--panel)] p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" value={form.slug} onChange={(e) => updateField("slug", e.target.value)} required className={inputClass} />
            </div>
          </div>
          <div>
        ...
        <div className="flex gap-3">
          <button type="button" onClick={() => router.back()} className="rounded-xl border border-[var(--line)] px-6 py-2.5 text-[11px] track uppercase text-[var(--muted)] hover:text-[var(--ink)] transition-colors cursor-pointer">
            Batal
          </button>
          <button type="submit" disabled={saving} className="rounded-full bg-[var(--gold)] px-8 py-2.5 text-[11px] track uppercase font-bold text-[#090A0C] hover:opacity-90 transition disabled:opacity-50 cursor-pointer">
